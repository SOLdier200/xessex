              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-white/10 rounded-xl overflow-hidden">
                  ...
                  <tbody>
                    ...
                    <tr className="border-t border-white/10"><td className="py-2 px-3">Liquidity Pools</td><td className="text-right py-2 px-3">20%</td><td className="text-right py-2 px-3">200,000,000</td></tr>
                    ...
                    <tr className="border-t border-white/10"><td className="py-2 px-3">A.I. Content</td><td className="text-right py-2 px-3">5%</td><td className="text-right py-2 px-3">50,000,000</td></tr>
