            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-white/70">
                <tr className="border-b border-white/5">
                  ...
                  <td className="text-right py-2 px-2 text-cyan-400">20</td>
                </tr>
                <tr className="border-b border-white/5">
                ...
                <tr className="border-b border-white/5">
                  ...
                  <td className="text-right py-2 px-2 text-cyan-400">400</td>
                </tr>
                <tr className="border-b border-white/5">
                ...
                <tr className="border-b border-white/5">
                  ...
                  <td className="text-right py-2 px-2 text-cyan-400">6,000</td>
                </tr>
                <tr>
