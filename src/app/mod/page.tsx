    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Link
            href="/admin"
            className="bg-gradient-to-br from-pink-500/10 to-purple-500/10 border border-pink-500/30 rounded-xl p-6 hover:border-pink-500/50 transition group"
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-xl font-semibold group-hover:text-pink-400 transition">Video Curation</h3>
            </div>
            <p className="text-gray-400">Review and approve/reject videos for the platform.</p>
          </Link>
