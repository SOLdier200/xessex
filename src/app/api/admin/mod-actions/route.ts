...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    actions: actions.map((a) => ({
      id: a.id,
      modId: a.modId,
      modDisplay: a.mod.email || a.mod.solWallet || a.mod.walletAddress || a.modId.slice(0, 8),
      modRole: a.mod.role,
      targetUserId: a.targetUserId,
      targetUserDisplay: a.targetUser.email || a.targetUser.solWallet || a.targetUser.walletAddress || a.targetUserId.slice(0, 8),
    ...
    moderators: moderators.map((m) => ({
      id: m.id,
      display: m.email || m.solWallet || m.walletAddress || m.id.slice(0, 8),
      role: m.role,
