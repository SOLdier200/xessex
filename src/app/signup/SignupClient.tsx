          ...
          <div className="relative w-full max-w-lg rounded-2xl neon-border bg-black/90 p-6">
              ...
              >
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    />
                    <span className="text-white font-semibold text-lg">sign up with Wallet</span>
                  </div>
                  <p className="text-white/60 text-sm">
            ...
            <div className="mt-5 p-3 rounded-xl bg-purple-500/10 border border-purple-400/30">
              <p className="text-sm text-white/70">
                Don&apos;t have a Solana Wallet? You can quickly install one{" "}
                <button
                  type="button"
            ...
            <div className="mt-4 text-center">
              <p className="text-xs text-white/50">
                Diamond members only connect with their wallets.
              </p>
            </div>
          </div>
        </div>
      ...
      {walletDownloadOpen && (
        <div className="fixed inset-0 z-[85] flex items-start sm:items-center justify-center px-4 py-6 overflow-y-auto overscroll-contain modal-scroll modal-safe min-h-[100svh] min-h-[100dvh]">
          ...
          <div className="relative w-full max-w-md rounded-2xl neon-border bg-black/90 p-6">
            ...
            <Link
              href="/login/diamond"
              className="flex items-center justify-center w-full py-3 mb-4 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 transition"
            >
              <Image
            ...
            <div className="flex justify-center gap-4">
              ...
              <a
                ...
                className="p-3 rounded-xl border border-purple-400/30 bg-purple-500/10 hover:bg-purple-500/20 transition"
              >
                <Image
                  src="/logos/phantomtrans.png"
                  alt="Phantom"
                  width={120}
                  height={40}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-xl border border-red-400/30 bg-red-500/10 hover:bg-red-500/20 transition"
              >
                <Image
                  src="/logos/backpacktrans.png"
                  alt="Backpack"
                  width={120}
                  height={40}
                  className="h-10 w-auto"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-xl border border-orange-400/30 bg-orange-500/10 hover:bg-orange-500/20 transition"
              >
                <Image
                  src="/logos/solflaretrans.png"
                  alt="Solflare"
                  width={120}
                  height={40}
                  className="h-10 w-auto"
            ...
            <div className="mt-5 p-3 rounded-xl bg-sky-500/10 border border-sky-400/30">
              <p className="text-xs text-sky-200">
                <strong>Tip:</strong> After installing, create a new wallet and securely save your recovery phrase. You&apos;ll use this wallet to sign in as Diamond Member and interact with the Xessex Protocol.
              </p>
            </div>
