...
export default function SignupPage() {
  ...
  const [currentUrl, setCurrentUrl] = useState("https://xessex.me/signup");
    ...
    <main className="min-h-screen">
      ...
      <div className="px-6 pb-10 flex justify-center">
        <div className="w-full max-w-xl space-y-6">
          {/* Signup Card */}
          <div className="rounded-2xl p-6 bg-black/30 border-2 border-cyan-500/50 shadow-[0_0_30px_rgba(6,182,212,0.3)]">
            <div className="flex justify-center mb-4">
              <Image
                src="/logos/textlogo/siteset3/signup5.png"
                alt="Sign Up"
                width={938}
                height={276}
            ...
            <div className="mb-5 rounded-xl border border-white/10 bg-white/5 px-4 py-4">
              ...
              <p className="text-sm text-white/70 mb-3 leading-relaxed">
                New users create an account simply by connecting &amp; signing with their Solana wallet — no email or password needed.
              </p>
              <ol className="list-decimal list-inside space-y-2 text-sm text-white/70 leading-relaxed">
                ...
                <li>
                  Open{" "}
                  <span className="text-white/90 font-medium">xessex.me</span>{" "}
                  in the wallet&apos;s built-in browser
                </li>
                <li>
                  Tap{" "}
                  <span className="text-white/90 font-medium">&quot;Select Wallet&quot;</span>{" "}
                  below, then{" "}
                  <span className="text-white/90 font-medium">&quot;Sign in with Wallet&quot;</span>{" "}
            ...
            <p className="text-sm text-white/70">
              Connect your wallet to create your account or sign in.
            </p>
